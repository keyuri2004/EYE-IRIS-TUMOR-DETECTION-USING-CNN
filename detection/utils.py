...
model_path = r'C:\Users\keyu2\Downloads\iris_tumor_detection-main\iris_tumor_detection-main\iris_tumor_detection-main\iris_tumor_detection\detection\iris_tumor_model_vgg16.keras'  # Update path if necessary
